...
import com.example.core.reader.parsers.TxtParser
...
class BookImporter(private val context: Context) {
    ...
    suspend fun getChaptersForBook(book: Book): List<com.example.domain.model.BookChapter> = withContext(Dispatchers.IO) {
