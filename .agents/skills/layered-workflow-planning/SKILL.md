...
- aligned with `.agents/planning/planning_contract.md`
...
Follow the shared planning artifact contract in `.agents/planning/planning_contract.md`.
...
The shared planning contract in `.agents/planning/planning_contract.md` is the single normative source for:
...
- global structure and exact layer syntax come from `.agents/planning/planning_contract.md`
...
- Exact syntax, section order, and layer rules come from `.agents/planning/planning_contract.md`
