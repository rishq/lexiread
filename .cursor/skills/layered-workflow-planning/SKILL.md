...
- aligned with `.cursor/planning/planning_contract.md`
...
Follow the shared planning artifact contract in `.cursor/planning/planning_contract.md`.
...
The shared planning contract in `.cursor/planning/planning_contract.md` is the single normative source for:
...
- global structure and exact layer syntax come from `.cursor/planning/planning_contract.md`
...
- Exact syntax, section order, and layer rules come from `.cursor/planning/planning_contract.md`
