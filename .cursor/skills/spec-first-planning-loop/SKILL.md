...
- `.cursor/planning/planning_contract.md` describes the format used inside solution specifications, including workflow notation, layers, and section structure.
