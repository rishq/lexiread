...
- Optional named layers such as `Data`, `Types`, `Tables`, `Detailed Workflow`, `Logic Details`, `Observed Existing Logic`, `Input Validation And Contracts`, `Implementation Logic`, `Implementation Logic Proposal`, and `Tests` when the user wants compatibility with planning artifacts that follow `.cursor/planning/planning_contract.md`
...
When the user wants compatibility with layered-workflow-planning or the shared planning contract in `.cursor/planning/planning_contract.md`, use the operators and layer syntax defined in the contract.
...
- If named layers are used, they stay compatible with layered-workflow-planning naming and with `.cursor/planning/planning_contract.md`
...
- If the user wants direct compatibility with forward solution planning documents, keep the reverse-engineered content in named layers such as `Data`, `Types`, `Tables`, `Detailed Workflow`, `Logic Details`, `Input Validation And Contracts`, `Implementation Logic`, `Implementation Logic Proposal`, `Observed Existing Logic`, and `Tests`, then place that content into a plan/spec that follows `.cursor/planning/planning_contract.md`
